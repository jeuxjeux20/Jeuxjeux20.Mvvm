...
namespace Jeuxjeux20.Mvvm
{
        ...
        where TViewModel : IViewModel<TModel> where TModel : class, new()
    {
        ...
        private abstract class PropertyChangedDealer
        {
            ...
            public static implicit operator Action<TViewModel>(PropertyChangedDealer d)
            {
                return d.Action;
            }

            public static implicit operator PropertyChangedEventHandler(PropertyChangedDealer d)
            {
                return d.Handler;
            }
        }
